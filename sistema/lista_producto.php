...
<body>
	...
	if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2 ){ ?>
		...
		<a href="stock0.php" class="btn_new " id=""><i class="far fa-file-excel"></i> Stock Cero</a>
		...
		$utilidad = ($data['inversion'] > 0) ? ($ganancia / $data['inversion'])*100 : 0;

		if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2 ){ ?>
		
				            <div><table><tr>
										<td colspan="" class="textright">Inversión Total</td>
